  ...
  const vehicles = [
    {
      ...
      img: "/images/v2_updates/moto.jpeg",
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(45deg, transparent 0%, rgba(255,255,255,0.18) 50%, transparent 100%)",
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, rgba(255,214,0,0.97), rgba(255,214,0,0.86))",
            boxShadow: "0 0 55px rgba(255,214,0,0.35)",
          }}
        >
          <div className="absolute inset-0 bg-black/5" />

          <div className="relative z-10 h-full w-full p-7 flex flex-col justify-between text-brand-green">
            <div>
              ...
              {vehicle.twoPlans ? (
                <div className="mt-5 grid gap-4">
                  {vehicle.twoPlans.map((plan: any, idx: number) => (
