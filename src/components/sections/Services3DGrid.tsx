...
export default function Services3DGrid() {
    const services = [
        ...
        },
        {
            ...
            image: "/images/v2_updates/FMPH0024.png",
        },
        {
            title: "SOAT",
            ...
            image: "/images/v2_updates/FMPH0025.png",
        },
        {
            title: "Traspasos",
            desc: "Gestionamos el cambio de propietario de tu vehículo ante el RUNT.",
            icon: <ArrowRightLeft size={32} className="text-brand-green" />,
            image: "/images/v2_updates/FMPH0026.png",
        },
        {
            title: "Duplicados",
            desc: "Obtén una copia de tu licencia o documentos rápidamente.",
